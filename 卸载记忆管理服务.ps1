# Qdrant 记忆管理器 - Windows 服务卸载脚本
# 使用方法：右键 - 以管理员身份运行

$ErrorActionPreference = "Continue"

Write-Host "========================================"
Write-Host "  Qdrant 记忆管理器 - 服务卸载程序"
Write-Host "========================================"
Write-Host ""
...
Write-Host ""
Write-Host "正在停止服务..."
Start-Process -FilePath "$SCRIPT_DIR\nssm\nssm.exe" -ArgumentList "stop $SERVICE_NAME" -NoNewWindow -Wait | Out-Null

Write-Host "正在删除服务..."
Start-Process -FilePath "$SCRIPT_DIR\nssm\nssm.exe" -ArgumentList "remove $SERVICE_NAME confirm" -NoNewWindow -Wait | Out-Null
...
Write-Host "========================================"
Write-Host ""
Write-Host "提示：日志文件仍保留在 logs 目录中"
Write-Host ""
Write-Host "按任意键退出..."
$null = $Host.UI.RawUI.ReadKey("NoEcho,IncludeKeyDown")
